...
parser.add_argument('--data_dir',
    default='../../learning-rewards-of-learners/data/atari-head/',
    help='data directory')
...
fps = 20
format="mp4v"
outvid= out_path+'/'+trial_name+'.mp4'
print(outvid)
...
for line in f:
    ...
    for j in range(0,len(gaze),2):
        ...
        if gaze_ignore[k]==0:
            cv2.circle(
                img, (int(x),int(y)), 5, (0,255,0), thickness=1, lineType=8, shift=0)
