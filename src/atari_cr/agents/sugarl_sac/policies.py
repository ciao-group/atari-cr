...
class DictCritic(BaseModel):
    ...
    def __init__(
        ...
        # List of dimensions of the action spaces in action_space Dict
        action_dims = get_action_dim(self.action_space)
...
class SugarlSACPolicy(BasePolicy):
    """
    """
